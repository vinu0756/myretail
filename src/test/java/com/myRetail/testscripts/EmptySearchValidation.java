...
public class EmptySearchValidation {
 ...
 @Test(description = "Blank search")
public void verifySearchBlank() {
 landingPage.searchBlank("");
 boolean flag = landingPage.isSearchErrorDisplayed("No product id entered to search!!!");
