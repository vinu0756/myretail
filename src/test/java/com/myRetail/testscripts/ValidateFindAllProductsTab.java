...
public class ValidateFindAllProductsTab {
 ...
 @AfterMethod
  ...
  landingPage.navigateToAllProductTab();
	...
	@Test(description = "Validation of Find All Product section and product Details Section")
    public void verifyFindAllProduct() {
		landingPage.navigateToAllProductTab();
