...
public abstract class BasePage<T> {
	...
	private static final String BASE_URL = "http://localhost:9006/myRetail/";
	...
	private void waitForPageToLoad(ExpectedCondition pageLoadCondition) {
		Wait wait = new FluentWait(getDriver()).withTimeout(LOAD_TIMEOUT, TimeUnit.SECONDS).pollingEvery(REFRESH_RATE,
				TimeUnit.SECONDS);
